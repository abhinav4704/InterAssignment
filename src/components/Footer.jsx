...
const Footer = () => {
  return (
    <footer className="w-full bg-black/60 backdrop-blur-sm border-t border-white/10 text-white py-6 px-4 sm:px-8">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
        ...
        <div className="flex justify-center sm:justify-end space-x-6 text-white text-2xl">
          ...
          <a href="mailto:elite8@example.com" className="hover:text-red-400 transition duration-300">
            <FaEnvelope />
          </a>
        </div>
      </div>
